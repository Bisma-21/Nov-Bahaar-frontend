...
const NavbarComponent = (props) => {
    ...
    const searchHandler = async () => {
        ...
        // dispatch(searchProductsAction(result.response))
        ...
        <>
            <Header>
                ...
                <MiddleDiv>
                    ...
                    <Label>BEAUTY</Label> */}
                    <input type="text" placeholder="Search Your Item Here........" onChange={titleHandler} />
                    <BiSearch style={{ fontSize: "20px" }} onClick={searchHandler} />
                </MiddleDiv>
                <RightDiv>
